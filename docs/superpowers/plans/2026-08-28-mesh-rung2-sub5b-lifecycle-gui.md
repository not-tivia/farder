...
- [x] **G3 — the lifecycle states**: "needs a key refresh" (ceiling), "sealed until
...
- [x] **G5 — theming x3.** (done per component as each landed; verified by the Gates grep) Every new class gets CSS in `discord-dark`,
